    ...
    routes: [
        ...
        },
        {
            ...
            children:[
                ...
                {
                    path: '/seasonStatistic',
                    component: resolve => require(['../components/page/SeasonStatistic.vue'], resolve)
                },
                {
                    path: '/realtime',
                    component: resolve => require(['../components/page/Realtime.vue'], resolve)
                },
                {
